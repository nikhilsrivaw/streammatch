...
// Configuration
const SUPABASE_URL = `https://oojkbkcrnvodhqmfzrsd.supabase.co`;
const SUPABASE_SERVICE_ROLE_KEY = `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9vamtia2NybnZvZGhxbWZ6cnNkIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NjQ2MDg3NywiZXhwIjoyMDcyMDM2ODc3fQ.S8SLxn3YDNMASd1IHQucXeW0mmqzZUbrfRg9sUEqnlg`;
